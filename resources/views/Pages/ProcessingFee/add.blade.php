                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>المبلغ المستبعد: <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>رصيد المتبي من الطالب : </label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>رصيد  الطالب الكلي :  </label>
                                    <input  class="form-control"  value="{{ number_format($student->student_account->sum('Debit'), 2) }}" type="text" readonly>
                                </div>
                            </div>
                        </div>
